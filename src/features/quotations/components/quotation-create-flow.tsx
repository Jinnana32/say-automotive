...
} from '@/components/shared/step-progress';
...
const STEP_ORDER: QuotationCreateStep[] = [
  'customer',
  'vehicle',
  'items',
  'review',
...
export function QuotationCreateFlow({
  ...
  const selectedCustomer =
    customerOptions.find((customer) => customer.id === values.customerId) ??
    null;
  const selectedVehicle =
    vehicleOptions.find((vehicle) => vehicle.id === values.vehicleId) ?? null;
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          This customer will be used for the quotation unless
                          you change the path.
                        </p>
                      </div>
                      <Button
                ...
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Search and select the customer record to continue the
                      quotation.
                    </p>
                  </div>
                  <Button
                        ...
                        >
                          <div className="flex items-center justify-between gap-3">
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                Use this customer for the quotation and
                      ...
                      <div className="rounded-2xl border border-primary/20 bg-primary/5 px-4 py-4">
                        <div className="flex flex-wrap items-center justify-between gap-3">
                          <div className="space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                              This vehicle is ready to be used for the
                              quotation.
                            </p>
                          </div>
                          <Button
                            ...
                            >
                              <div className="flex items-center justify-between gap-3">
                                <div>
                                  ...
                                  <p className="text-xs text-muted-foreground">
                                    Use this vehicle for the quotation and later
                                    service history.
                                  </p>
                                </div>
                                {isSelected ? (
      ...
      currentStep === 'summary' ? (
        <form action={quotationFormAction} className="space-y-6">
          ...
          <input
            type="hidden"
            name="itemsJson"
            value={serializeQuotationItems(values.items)}
          />
                  ...
                  <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_220px]">
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        value={values.natureOfRepair}
                        onChange={(event) =>
                          updateFormValue('natureOfRepair', event.target.value)
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        value={values.inspectionNotes}
                        onChange={(event) =>
                          updateFormValue('inspectionNotes', event.target.value)
                        }
                        ...
                        >
                          <div className="mb-4 flex items-center justify-between gap-3">
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                Capture the actual quoted product, service, or
                                manual labor line.
                              </p>
                            </div>
                            <Button
                                ...
                                onChange={(event) =>
                                  updateQuotationItem(setValues, item.key, {
                                    itemType: event.target
                                      .value as QuotationFormItem['itemType'],
                                    productId: '',
                                    serviceId: '',
                                    description: '',
                  ...
                  <div className="rounded-2xl border border-border/70 bg-muted/20 px-4 py-4">
                    ...
                    <div className="mt-4 space-y-3 text-sm">
                      <SummaryRow
                        ...
                        value={selectedCustomer ? 'Yes' : 'No'}
                      />
                      <SummaryRow
                        label="Vehicle ready"
                        value={selectedVehicle ? 'Yes' : 'No'}
                      />
                      <SummaryRow
...
function QuickCustomerCreateForm({
  ...
  >(
    quickCreateCustomerForQuotationAction,
    INITIAL_QUOTATION_CREATE_FLOW_ACTION_STATE,
  );
  const { values, setValues, updateFormValue } =
  ...
  return (
    ...
    >
      <form action={formAction} className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(event) =>
                updateFormValue('contactNumber', event.target.value)
              }
        ...
        <div className="flex justify-end">
          <SubmitButton pendingLabel="Adding customer...">
            Add customer to intake
          </SubmitButton>
        </div>
      </form>
    </SectionCard>
...
function QuickVehicleCreateForm({
  ...
  const { values, setValues, updateFormValue } =
    useFormValues(initialVehicleValues);
  const normalizedMake = values.make.trim().toLowerCase();
  const filteredModels = normalizedMake
    ? lookupData.models.filter(
        (item) => item.makeName.trim().toLowerCase() === normalizedMake,
      )
    : [];
  ...
  return (
    ...
    >
      <form action={formAction} className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(event) =>
                updateFormValue('plateNumber', event.target.value)
              }
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(event) =>
                updateFormValue('mileage', event.target.value)
              }
            />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <TextAutocomplete
              ...
              options={lookupData.transmissions.map((option) => ({
                value: option,
              }))}
            />
          ...
          <div className="space-y-2">
            ...
            <TextAutocomplete
              ...
              options={lookupData.fuelTypes.map((option) => ({
                value: option,
              }))}
            />
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(event) =>
                updateFormValue('engineSize', event.target.value)
              }
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(event) =>
                updateFormValue('variant', event.target.value)
              }
            />
        ...
        <div className="flex justify-end">
          <SubmitButton pendingLabel="Adding vehicle...">
            Add vehicle to intake
          </SubmitButton>
        </div>
      </form>
    </SectionCard>
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      ...
      >
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {existingDisabled
            ? 'Not available yet for this step.'
            : existingDescription}
        </p>
      </button>
      <button
